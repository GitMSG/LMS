  ...
  <div id="training-form">
    ...
    <form class="new-training-form" @submit.prevent="createTraining">
      <div class="training-card">
        ...
        <input type="text" v-model="training.provider" />
        <br />
        ...
        <input type="date" v-model="training.date" />
        <br />
        ...
        <div v-if="compliance === false">
          ...
          <input :bind="training.electiveTime" @input="handleInputElective($event.target.value)" />
          <br />
        </div>
